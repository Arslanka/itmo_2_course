...
import SimpleIterationsSystemEquationMethodService from '../services/SimpleIterationsSystemEquationMethodService';
import FunctionPlot from './FunctionPlot';

class SimpleIterationsEquationMethodComponent extends Component {
    state = {
        equation_number: '1',
        solution: {},
        left: '',
    ...
    handleSubmit = event => {
        ...
        SimpleIterationsSystemEquationMethodService.solveSimpleIterationsEquationMethodResult(this.state.equation_number, this.state.left, this.state.right, this.state.eps)
            .then((
                    res
                ) => this.setState({
                        solution: res.data
...
export default SimpleIterationsEquationMethodComponent;