...
import TrapezoidIntegrationMethodService from '../services/TrapezoidIntegrationMethodService';
import Modal from './Modal';

class TrapezoidIntegrationMethodComponent extends Component {
    state = {
        equation_number: '1',
        left: '',
        right: '',
    ...
    handleSubmit = event => {
        ...
        TrapezoidIntegrationMethodService.solveByTrapezoidIntegrationMethod(this.state.equation_number, this.state.left, this.state.right, this.state.partition, this.state.accuracy)
            .then((
                    res
                ) => this.setState({
                        solution: res.data,
...
export default TrapezoidIntegrationMethodComponent;