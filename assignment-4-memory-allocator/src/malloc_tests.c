...
bool test_allocation() {
    ...
    void *heap = heap_init(HEAP_SIZE), *temp = _malloc(10);
...
bool test_block_free() {
    print_message(stdout, ">>%s\n", "Test 2: Free block");
    void *heap = heap_init(HEAP_SIZE), *_1 = _malloc(10), *_2 = _malloc(10);
    debug_heap(stdout, heap);
    _free(_1);
    debug_heap(stdout, heap);
    _free(_2);
...
bool test_multiple_block_free() {
    ...
    void *heap = heap_init(HEAP_SIZE), *_1 = _malloc(10), *_2 = _malloc(10), *_3 = _malloc(10);
    debug_heap(stdout, heap);
    _free(_1);
    _free(_2);
    debug_heap(stdout, heap);
